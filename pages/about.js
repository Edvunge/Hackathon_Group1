export default function About() {
    return (<div> <h1>What is the Pomodoro Technique?</h1>
        <p>The secret to effective time management is...thinking in tomatoes rather than hours? It may seem silly at first, but millions of people swear by the life-changing power to the Pomodoro Technique. (Pomodoro is Italian for tomato. 🍅)
            ...
            <li> Have lots of open-ended work that could take unlimited  </li>
            <li>  amounts of time (e.g., studying for an exam, research for a blog post, etc.)</li>
